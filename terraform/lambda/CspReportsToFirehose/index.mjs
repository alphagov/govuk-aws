...
function buildReport (json, sourceIp, userAgent) {
  ...
  return {
    time: now.toISOString().replace('T', ' ').substr(0, 19), // Hive/Athena demands yyyy-mm-dd hh:mm:ss and JS seems to have no strftime function
    ...
    violation_directive: normaliseInputString(cspReport['violation-directive']),

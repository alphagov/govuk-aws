...
| [aws_acm_certificate.alb_internal_cert](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/data-sources/acm_certificate) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_alb_internal_certname"></a> [alb\_internal\_certname](#input\_alb\_internal\_certname) | The ACM cert domain name to find the ARN of | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_locations_api_alb_internal_address"></a> [locations\_api\_alb\_internal\_address](#output\_locations\_api\_alb\_internal\_address) | AWS' internal DNS name for the locations api ALB |

...
module "vpc" {
  ...
  name         = var.vpc_name
  cidr         = var.vpc_cidr
  default_tags = map("Project", var.stackname, "Environment", var.aws_environment, "Product", "GOVUK", "Owner", "govuk-replatforming-team@digital.cabinet-office.gov.uk", "System", "Network")
}

...
resource "aws_elb" "publishing-api_external_elb" {
...
resource "aws_route53_record" "service_record" {
  ...
  alias {
    name                   = "${aws_elb.publishing-api_external_elb.dns_name}"
    zone_id                = "${aws_elb.publishing-api_external_elb.zone_id}"
...
module "publishing-api" {
  ...
  instance_elb_ids              = ["${aws_elb.publishing-api_external_elb.id}"]
  asg_max_size                  = "2"
  asg_min_size                  = "2"
...
output "publishing-api_elb_address" {
  value       = "${aws_elb.publishing-api_external_elb.dns_name}"

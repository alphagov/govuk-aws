...
| Name | Description |
|------|-------------|
| <a name="output_assets_service_record"></a> [assets\_service\_record](#output\_assets\_service\_record) | DNS service name for assets |
| <a name="output_efs_mount_target_dns_names"></a> [efs\_mount\_target\_dns\_names](#output\_efs\_mount\_target\_dns\_names) | DNS name for the mount targets |

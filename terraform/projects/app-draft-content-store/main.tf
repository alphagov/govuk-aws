...
resource "aws_elb" "draft-content-store_internal_elb" {
  ...
  security_groups = ["${data.terraform_remote_state.infra_security_groups.outputs.sg_draft-content-store_internal_elb_id}"]
  internal        = "true"
...
module "draft-content-store" {
  ...
  instance_security_group_ids   = ["${data.terraform_remote_state.infra_security_groups.outputs.sg_draft-content-store_id}", "${data.terraform_remote_state.infra_security_groups.outputs.sg_management_id}"]

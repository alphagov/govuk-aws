...
data "aws_iam_policy_document" "training_mongo_api_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*mongo-api*",
...
data "aws_iam_policy_document" "training_mongo_router_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*router_backend*",
      "arn:aws:s3:::govuk-training-database-backups/*mongo-router*",
      "arn:aws:s3:::govuk-integration-database-backups",
...
data "aws_iam_policy_document" "training_mongodb_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*mongo*",
      "arn:aws:s3:::govuk-integration-database-backups",
...
data "aws_iam_policy_document" "training_elasticsearch_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*elasticsearch*",
      "arn:aws:s3:::govuk-integration-database-backups",
...
data "aws_iam_policy_document" "training_dbadmin_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*mysql*",
      "arn:aws:s3:::govuk-training-database-backups/*postgres*",
      "arn:aws:s3:::govuk-integration-database-backups",
...
data "aws_iam_policy_document" "training_transition_dbadmin_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*transition*",
      "arn:aws:s3:::govuk-integration-database-backups",
...
data "aws_iam_policy_document" "training_publishing-api_dbadmin_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*publishing-api*",
    ]
  }
}
...
data "aws_iam_policy_document" "training_email-alert-api_dbadmin_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*email-alert-api*",
    ]
  }
}
...
data "aws_iam_policy_document" "training_graphite_database_backups_reader" {
  statement {
    ...
    resources = [
      "arn:aws:s3:::govuk-training-database-backups",
      "arn:aws:s3:::govuk-training-database-backups/*whisper*",
      "arn:aws:s3:::govuk-integration-database-backups",

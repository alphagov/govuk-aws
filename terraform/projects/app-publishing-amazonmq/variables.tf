...
variable "publishing_amazonmq_instance_count" {
  type        = number
  description = "Number of instances the broker has/should have. This would normally be 1 for a deployment_mode of SINGLE_INSTANCE, 2 for ACTIVE_STANDBY_MULTI_AZ, 2 for CLUSTER_MULTI_AZ. Defaults to 1."
  default     = 1
}

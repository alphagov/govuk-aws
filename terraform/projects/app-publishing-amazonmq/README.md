...
| <a name="input_publishing_amazonmq_passwords"></a> [publishing\_amazonmq\_passwords](#input\_publishing\_amazonmq\_passwords) | encrypted secrets in govuk-aws-data, in the form username = password | `map(any)` | n/a | yes |

...
| Name | Description |
|------|-------------|
| <a name="output_transition-db-admin_elb_dns_name"></a> [transition-db-admin\_elb\_dns\_name](#output\_transition-db-admin\_elb\_dns\_name) | DNS name to access the transition-db-admin service |

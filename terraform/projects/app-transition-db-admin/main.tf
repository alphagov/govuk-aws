...
resource "aws_elb" "transition-db-admin_elb" {
  ...
  security_groups = ["${data.terraform_remote_state.infra_security_groups.outputs.sg_transition-db-admin_elb_id}"]
  internal        = "true"
...
module "transition-db-admin" {
  ...
  instance_security_group_ids   = ["${data.terraform_remote_state.infra_security_groups.outputs.sg_transition-db-admin_id}", "${data.terraform_remote_state.infra_security_groups.outputs.sg_management_id}"]
...
resource "aws_iam_role_policy_attachment" "write_transition-db-admin_database_backups_iam_role_policy_attachment" {
  ...
  policy_arn = "${data.terraform_remote_state.infra_database_backups_bucket.outputs.transition_dbadmin_write_database_backups_bucket_policy_arn}"
}
...
resource "aws_iam_role_policy_attachment" "read_production_transition-db-admin_database_backups_iam_role_policy_attachment" {
  ...
  role       = "${module.transition-db-admin.instance_iam_role_name}"
  policy_arn = "${data.terraform_remote_state.infra_database_backups_bucket.outputs.production_transition_dbadmin_read_database_backups_bucket_policy_arn}"
}
...
resource "aws_iam_role_policy_attachment" "read_integration_transition-db-admin_database_backups_iam_role_policy_attachment" {
  ...
  role       = "${module.transition-db-admin.instance_iam_role_name}"
  policy_arn = "${data.terraform_remote_state.infra_database_backups_bucket.outputs.integration_transition_dbadmin_read_database_backups_bucket_policy_arn}"
}
...
resource "aws_iam_role_policy_attachment" "read_staging_transition-db-admin_database_backups_iam_role_policy_attachment" {
  ...
  role       = "${module.transition-db-admin.instance_iam_role_name}"
  policy_arn = "${data.terraform_remote_state.infra_database_backups_bucket.outputs.staging_transition_dbadmin_read_database_backups_bucket_policy_arn}"
}

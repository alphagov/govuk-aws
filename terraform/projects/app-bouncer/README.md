...
| Name | Type |
|------|------|
| [aws_elb.bouncer_external_elb](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/resources/elb) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_bouncer_elb_address"></a> [bouncer\_elb\_address](#output\_bouncer\_elb\_address) | AWS' internal DNS name for the bouncer ELB |

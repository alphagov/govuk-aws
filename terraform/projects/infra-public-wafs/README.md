...
| <a name="input_cache_public_base_rate_limit"></a> [cache\_public\_base\_rate\_limit](#input\_cache\_public\_base\_rate\_limit) | Token used by the CDN to skip rate limiting | `string` | `""` | no |

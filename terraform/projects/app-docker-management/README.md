...
| Name | Source | Version |
|------|--------|---------|
| alarms-elb-docker-management-internal | ../../modules/aws/alarms/elb |  |
| docker_management | ../../modules/aws/node_group |  |
...
| Name | Description |
|------|-------------|
| docker\_management\_etcd\_elb\_dns\_name | DNS name to access the docker\_management service |
| etcd\_service\_dns\_name | DNS name to access the node service |

...
| Name | Type |
|------|------|
| [aws_elb.cache_elb](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/resources/elb) | resource |
| [aws_elb.cache_external_elb](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/resources/elb) | resource |
...
| [aws_route53_record.cache_external_service_record](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/resources/route53_record) | resource |
| [aws_route53_record.cache_publicapi_service_record](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/resources/route53_record) | resource |
| [aws_route53_record.cache_service_record](https://registry.terraform.io/providers/hashicorp/aws/2.46.0/docs/resources/route53_record) | resource |
...
| <a name="input_asg_size"></a> [asg\_size](#input\_asg\_size) | The autoscaling groups desired/max/min capacity | `string` | `"9"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_cache_elb_dns_name"></a> [cache\_elb\_dns\_name](#output\_cache\_elb\_dns\_name) | DNS name to access the cache service |
| <a name="output_cache_external_elb_dns_name"></a> [cache\_external\_elb\_dns\_name](#output\_cache\_external\_elb\_dns\_name) | DNS name to access the external cache service |
